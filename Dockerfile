...
# copy application 
COPY /src/slave-owner-servermodule/slave-owner-servermodule/bin/Debug/netcoreapp2.2/publish/ /data/slave-owner/
...
#CMD ["scp:5532", "srp:5533", "rip:127.0.0.1", "rcp:5522", "rrp:5523"]